...
values(1101, 1, 'Prof. Samuel Broverman''s weekly question', '');

update bs_tests
set description=
"<p> All questions and solutions in this directory are transformed from <a href='http://www.sambroverman.com/question.html' target='_blank' >'Question of the week' of Prof. Samuel Broverman's website.</a></p>
<p> They are <b>Copyrighted by the Prof. Samuel Broverman.  Posted with permission. </b></p>
<p> Prof. Samuel Broverman may release new questions and those new questions may not be updated at here immediately. 
Please check with <a href='http://www.sambroverman.com' target='_blank' >Prof. Samuel Broverman's website.</a> for the latest questions.</p>
<p> Users are supposed to take their own risky to use questions and solutions provided at here for preparing their exams.</p>
"
where id=1101;

delete from bs_questions where test_id = 1101;

insert into bs_questions(id, test_id, name, question, option1, option2, option3, option4, option5, answer, solution)
values(1101001, 1101, 'Question of week 2005-07-25', 
...
insert into bs_questions(id, test_id, name, question, option1, option2, option3, option4, option5, answer, solution)
values(1101002, 1101, 'Question of week 2005-08-01', 
...
insert into bs_questions(id, test_id, name, question, option1, option2, option3, option4, option5, answer, solution)
values(1101003, 1101, 'Question of week 2005-08-08', 
