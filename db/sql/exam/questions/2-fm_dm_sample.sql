...
update bs_tests
set name="Official Samples for Derivatives Markets"
where id=2002;


update bs_tests
set description=
"<p> All questions and solutions in this test are transformed from SOA/CAS official 'SAMPLE QUESTIONS FOR DERIVATIVES MARKETS' document.</p>
...
delete from bs_questions where test_id = 2002;

insert into bs_questions(id, test_id, name, question, option1, option2, option3, option4, option5, answer, solution)
values(2002001, 2002, 'Q1', 

"<p>Which statement about zero-cost purchased collars is FALSE?</p>",

"A zero-width, zero-cost collar can be created by setting both the put and call strike prices at the forward price.",
"There are an infinite number of zero-cost collars.",
"The put option can be at-the-money.",
"The call option can be at-the-money.",
...
"Buy the put and sell the call, receive 23.81",
"Buy the put and sell the call, spend 23.81",
"Buy the put and sell the call, no cost",
"Buy the call and sell the put, receive 23.81",
"Buy the call and sell the put, spend 23.81",
...
"It will be strictly between 100 and 105",
"It will be equal to 105",
"It will be greater than 105.",
...
"Forward contract",
"This arrangement is not possible due to arbitrage opportunities",
...
"Buy a 90 put, buy a 110 put, sell two 100 puts",
"Buy a 90 call, buy a 110 call, sell two 100 calls",
...
"40.44 < S1 < 42.31",
"S1 > 42.31",
"There is no price for S1 at which this situation occurs.",
...
"Profit: -22.64  Name: Floor",
"Profit: -17.56  Name: Floor",
"Profit: -22.64  Name: Cap",
"Profit: -17.56  Name: Cap",
"Profit: -22.64  Name: 'Written' Covered Call",
...
"Maximum Profit: 3.42  Maximum Loss: 4.58",
"Maximum Profit: 4.58  Maximum Loss: 10.42",
"Maximum Profit: Unlimited  Maximum Loss: 10.42",
"Maximum Profit: 4.58  Maximum Loss: Unlimited",
"Maximum Profit: Unlimited  Maximum Loss: Unlimited",
...
"Buy observed forward, sell synthetic forward, Profit = 0.34",
"Buy observed forward, sell synthetic forward, Profit = 0.78",
"Buy observed forward, sell synthetic forward, Profit = 1.35",
"Sell observed forward, buy synthetic forward, Profit = 0.78",
"Sell observed forward, buy synthetic forward, Profit = 0.34",
...
"Derivatives are used to satisfy regulatory, tax, and accounting constraints.",
...
"In an insurance market, individuals that do not incur losses have shared risk with individuals that do incur losses.",
"Insurance companies can share risk by ceding some of the excess risk from large claims to reinsurers.",
"Reinsurance companies can further share risk by investing in catastrophic bonds.",
"Risk-sharing reduces diversifiable risk, more so than reducing non-diversifiable risk.",
"Ideally, any risk-sharing mechanism should benefit all parties sharing the risk.",
...
insert into bs_questions(id, test_id, name, question, option1, option2, option3, option4, option5, answer, solution)
values(2002028, 2002, 'Q28', 

"<p>Which of the following is NOT among a firm's rationales to hedge?</p>",

"To reduce taxes through income shifting",
"To reduce the probability of bankruptcy or distress",
"To reduce the costs associated with external financing",
"To reduce the exposure to exchange rate risk",
"To reduce the debt proportion of external financin",
...
"Prepaid forward contract, Outright purchase, Forward contract, Fully leveraged purchase",
"Outright purchase, Prepaid forward contract, Forward contract, Fully leveraged purchase",
"Outright purchase, Prepaid forward contract, Forward contract, Fully leveraged purchase",
"Prepaid forward contract, Outright purchase, Fully leveraged purchase, Forward contract",
"Outright purchase, Prepaid forward contract, Fully leveraged purchase, Forward contract",
...
"Contracts are settled daily, and marked-to-market.",
"Contracts are more liquid, as one can offset an obligation by taking the opposite position.",
"Contracts are more customized to suit the buyer's needs.",
"Contracts are structured to minimize the effects of credit risk.",
"Contracts have price limits, beyond which trading may be temporarily halted.",
