...
-- --------------------------------------------------------
CREATE DATABASE `nadlabs_app_db` ;
USE nadlabs_app_db;
-- 
-- Table structure for table `blocked_ip_domains`
-- This table has been replaced with the security_blocks table
...
-- 
-- Table structure for table `blogroar_blogtable`
-- 

CREATE TABLE `blogroar_blogtable` (
  ...
  `regkey` varchar(75) NOT NULL,
  `visits` int(10) NOT NULL,
  `3purl` varchar(300) default NULL,
  PRIMARY KEY  (`blogid`)
...
-- 
-- Table structure for table `blogroar_keygen`
-- 

CREATE TABLE `blogroar_keygen` (
  `kid` int(255) NOT NULL auto_increment,
...
-- 
-- Table structure for table `blogroar_shareblog`
-- 

CREATE TABLE `blogroar_shareblog` (
  `shareid` int(255) NOT NULL auto_increment,
  `keygen` varchar(100) NOT NULL,
  `regblogid` int(255) NOT NULL,
  `valid` int(2) NOT NULL,
  PRIMARY KEY  (`shareid`)
...
CREATE TABLE `comments` (
  ...
  `reply_to_comment` int(10) NOT NULL,
  `valid` int(2) NOT NULL,
  `reply_flag` int(1) NOT NULL,
...
CREATE TABLE `user_table` (
  ...
  `browser` varchar(5) default NULL,
...
(3, 'Modertator', 'Modertator user group - protected', 1);
